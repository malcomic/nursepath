...
export default function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(
    authError ? 'Unable to sign in. Please try again.' : null
  );
  ...
  return (
    <Card>
      <div className="mb-6 text-center">
        <h1 className="mb-2 font-display text-2xl font-extrabold text-navy-800">Sign in</h1>
        <p className="text-sm text-navy-400">
          Access your purchases and library with the same email you use at checkout.
        </p>
      </div>
