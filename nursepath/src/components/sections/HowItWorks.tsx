...
const steps = [
  {
    ...
    description: 'Explore our comprehensive collection of nursing study guides organized by category and exam type.',
  },
  {
    number: '02',
    icon: ShoppingCart,
  ...
  },
  {
    ...
    icon: CheckCircle,
    title: 'Ace Your Exam',
    description: 'Study with confidence using our proven materials and pass your exams with flying colors.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Getting started is simple. Follow these four easy steps to begin your journey to exam success.
          </p>
        </div>
